...
AI 获授权编写、修改、测试和验证全部项目代码，包括 Flutter 应用行为、应用测试、Supabase migration/RLS、CLI 配置与资料导入支持。该授权不改变已批准的产品语义、数据所有权或权限规则；详见 [ADR 0016](../../adr/0016-ai-managed-supabase-development-environment.md)。
