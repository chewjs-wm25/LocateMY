...
root=Path.cwd();output=root/'build/transit-wave5-evidence';output.mkdir(parents=True,exist_ok=True)
...
with tempfile.TemporaryDirectory(prefix='locatemy-transit-production-') as temporary:
