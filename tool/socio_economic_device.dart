...
const int fixturePort = int.fromEnvironment('LOCATEMY_SOCIO_FIXTURE_PORT');
...
Future<void> main() async {
  ...
  try {
    ...
    debugPrint('SOCIO_DEVICE: REAL_SIGNED_IN');
  } catch (_) {
    debugPrint('SOCIO_DEVICE: FAILED (details redacted)');
    exitCode = 1;
  } finally {
    fixture.close();
  }
