...
const int fixturePort = int.fromEnvironment('LOCATEMY_CRIME_FIXTURE_PORT');
...
Future<void> main() async {
  ...
  try {
    ...
    debugPrint('CRIME_DEVICE: REAL_SIGNED_IN');
  } catch (_) {
    debugPrint('CRIME_DEVICE: FAILED (details redacted)');
    exitCode = 1;
  } finally {
    fixture.close();
  }
