...
root=Path.cwd();output=root/'build/integration-evidence';output.mkdir(parents=True,exist_ok=True)
...
with tempfile.TemporaryDirectory(prefix='locatemy-integration-production-') as temporary:
