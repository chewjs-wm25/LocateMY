...
const int fixturePort = int.fromEnvironment('LOCATEMY_COST_FIXTURE_PORT');
...
Future<void> main() async {
  ...
  try {
    ...
    debugPrint('COST_DEVICE: REAL_SIGNED_IN');
  } catch (_) {
    debugPrint('COST_DEVICE: FAILED (details redacted)');
    exitCode = 1;
  } finally {
    fixture.close();
  }
