...
root=Path.cwd();output=root/'build/socio-wave6-evidence';output.mkdir(parents=True,exist_ok=True)
...
with tempfile.TemporaryDirectory(prefix='locatemy-socio-production-') as temporary:
