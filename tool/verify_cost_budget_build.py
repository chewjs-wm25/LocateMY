...
root=Path.cwd();output=root/'build/cost_budget-wave6-evidence';output.mkdir(parents=True,exist_ok=True)
...
with tempfile.TemporaryDirectory(prefix='locatemy-cost_budget-production-') as temporary:
