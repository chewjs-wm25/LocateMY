...
const int fixturePort = int.fromEnvironment('LOCATEMY_PROPERTY_FIXTURE_PORT');
...
Future<void> main() async {
  ...
  try {
    ...
    debugPrint('PROPERTY_DEVICE: REAL_SIGNED_IN');
  } catch (_) {
    debugPrint('PROPERTY_DEVICE: FAILED (details redacted)');
    exitCode = 1;
  } finally {
    fixture.close();
  }
