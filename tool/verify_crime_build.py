...
root=Path.cwd();output=root/'build/crime-wave5-evidence';output.mkdir(parents=True,exist_ok=True)
...
with tempfile.TemporaryDirectory(prefix='locatemy-crime-production-') as temporary:
