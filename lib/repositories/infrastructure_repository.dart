...
import '../core/district_matcher.dart';
import '../core/ici_score.dart';
import '../core/normalized_score.dart';
...
class InfrastructureRepository {
  ...
  double? _bedsPerCapitaScore(
    ...
    for (final e in latestByDistrict.entries) {
      final pop =
          _populationFor(popByDistrict, e.key, dateByDistrict[e.key] ?? '');
  ...
  Map<String, dynamic>? _latestAmenityFor(
    List<dynamic> rows,
    String district,
  ) {
