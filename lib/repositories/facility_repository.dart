...
class FacilityRepository {
  ...
  static const String _amenityPattern = r'^(hospital|clinic|doctors|dentist|pharmacy|'
  ...
  List<NearbyFacility> _parseFacilities(
    ...
    for (final element in elements) {
      ...
      final lat = element['lat'] ?? (center is Map<String, dynamic> ? center['lat'] : null);
      final lon = element['lon'] ?? (center is Map<String, dynamic> ? center['lon'] : null);
    ...
    for (final f in facilities) {
      final key = '${f.type}|${f.category}|${f.name}|'
