...
class PropertyDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<PropertyViewModel, PropertyInspection>(
          ...
          appBar: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                onPressed: () =>
                    _showDeleteConfirmation(context, currentInspection.id),
              ),
            ],
          ),
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Notes
                if (currentInspection.notes.isNotEmpty)
                  _buildNotesCard(context, currentInspection, l10n),
      ...
      child: Column(
        ...
        children: [
          ...
          StatusBadge(
            ...
            type: inspection.hasFloodHistory
                ? StatusType.danger
                : StatusType.success,
  ...
  Widget _buildChecklistCard(
    ...
    return BentoCard(
      child: Column(
        ...
        children: [
          Text(
            l10n.monsoonChecklist,
            style: const TextStyle(fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 12),
          _buildChecklistItem(
            l10n.drainage,
            inspection.monsoonChecklist['drainage_score'] ?? 0,
          ),
          _buildChecklistItem(
            l10n.waterproofing,
            inspection.monsoonChecklist['waterproofing_score'] ?? 0,
          ),
          _buildChecklistItem(
            l10n.humidity,
            inspection.monsoonChecklist['humidity_score'] ?? 0,
          ),
          _buildChecklistItem(
            l10n.lighting,
            inspection.monsoonChecklist['lighting_score'] ?? 0,
          ),
        ],
      ),
    );
