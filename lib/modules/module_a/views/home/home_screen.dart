                    ...
                    children: [
                      Expanded(
                        child: _buildMetricCard(
                          ...
                          value: stats.unemploymentRate != null
                      ...
                      Expanded(
                        child: _buildMetricCard(
                          ...
                          value: stats.medianIncome != null
                              ? 'RM ${NumberFormat("#,###").format(stats.medianIncome)}'
                              : null,
                    ...
                    children: [
                      Expanded(
                        child: _buildMicroInfoCard(
                          ...
                          value: stats.inflationRate != null
                              ? '${stats.inflationRate!.toStringAsFixed(1)}%'
                              : null,
                          type: (stats.inflationRate ?? 5.0) < 3.0
                              ? StatusType.success
                              : StatusType.warning,
                        ),
                      ),
                      ...
                      Expanded(
                        child: _buildMicroInfoCard(
                          context,
                          title: l10n.oprRate,
                          value: stats.oprRate != null
                              ? '${stats.oprRate!.toStringAsFixed(2)}%'
                              : null,
  ...
  Widget _buildHeroCard(BuildContext context, HomeStats stats) {
    ...
    if (index == null) {
      return BentoCard(
        ...
        child: const Center(
          child: Text('搬迁指数计算中...', style: TextStyle(color: Colors.white)),
        ),
      );
    }
