...
class InfrastructureView extends StatelessWidget {
  ...
  void _ensureLoaded(
    InfrastructureViewModel provider,
  ...
  Widget build(BuildContext context) {
    ...
    final infraProvider = Provider.of<InfrastructureViewModel>(context);
    ...
    final iciScore =
        infraProvider.weightedIciScore ??
        ...
        Row(
          children: [
            ...
            _buildServiceItem(
              ...
              l10n.electricNetwork,
              _scoreText(scores, 'power'),
              AppColors.warning,
            ),
          ],
        ),
        ...
        Row(
          children: [
            ...
            _buildServiceItem(
              ...
              l10n.educationalResources,
              _scoreText(scores, 'education'),
              AppColors.success,
            ),
          ],
        ),
    ...
    return BentoCard(
      child: Column(
        ...
        children: [
          ...
          _buildWeightSlider(l10n.commercialConvenience, provider.wTransit, (
            v,
          ) {
