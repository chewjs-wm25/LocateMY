class HomeStats {
  ...
  factory HomeStats.fromJson(Map<String, dynamic> json) {
    return HomeStats(
      gdpGrowth: json['gdpGrowth'] != null
          ? (json['gdpGrowth'] as num).toDouble()
          : null,
      gdpTrend: json['gdpTrend'] != null
          ? (json['gdpTrend'] as List)
                .map((e) => GDPDataPoint.fromJson(e))
                .toList()
          : null,
      unemploymentRate: json['unemploymentRate'] != null
          ? (json['unemploymentRate'] as num).toDouble()
          : null,
      unemploymentTrend: json['unemploymentTrend'] != null
          ? (json['unemploymentTrend'] as num).toDouble()
          : null,
      medianIncome: json['medianIncome'] as int?,
      incomeTrend: json['incomeTrend'] != null
          ? (json['incomeTrend'] as num).toDouble()
          : null,
      inflationRate: json['inflationRate'] != null
          ? (json['inflationRate'] as num).toDouble()
          : null,
      oprRate: json['oprRate'] != null
          ? (json['oprRate'] as num).toDouble()
          : null,
      relocationIndex: json['relocationIndex'] != null
          ? (json['relocationIndex'] as num).toDouble()
          : null,
