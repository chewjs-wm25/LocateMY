  ...
  static FacilityCategory _determineCategory(Map<String, dynamic> tags) {
    if (tags.containsKey('amenity')) {
      ...
      if ([
        ...
        return FacilityCategory.healthcare;
      if ([
        'school',
        'university',
        'college',
      ...
      if ([
        ...
        return FacilityCategory.living;
      if (['police', 'fire_station', 'post_office'].contains(amenity))
        return FacilityCategory.safety;
      if (['place_of_worship'].contains(amenity))
        return FacilityCategory.leisure;
      if ([
        'bus_station',
        'ferry_terminal',
        'charging_station',
    ...
    if (tags.containsKey('shop')) {
      ...
      if (['supermarket', 'convenience', 'mall', 'pharmacy'].contains(shop))
        return FacilityCategory.living;
    }
    if (tags.containsKey('railway') || tags.containsKey('station'))
      return FacilityCategory.transport;
    ...
    if (tags.containsKey('landuse') && tags['landuse'] == 'industrial')
      return FacilityCategory.risk;
    if (tags.containsKey('highway')) {
      final highway = tags['highway'];
      if (['bus_stop', 'motorway_junction'].contains(highway))
        return FacilityCategory.transport;
    }
    if (tags.containsKey('barrier') && tags['barrier'] == 'toll_booth')
      return FacilityCategory.transport;
