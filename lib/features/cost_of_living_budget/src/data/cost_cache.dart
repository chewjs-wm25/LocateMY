...
final class CostCache {
  ...
  CostCache(Database database, DateTime Function() clock)
    : _database = database,
      _clock = clock;
  Future<void> _initialize() async {
    await _database.execute(
      'CREATE TABLE IF NOT EXISTS cost_public_cache (cache_key TEXT PRIMARY KEY, version INTEGER NOT NULL, payload TEXT NOT NULL, fetched_at TEXT NOT NULL, expires_at TEXT NOT NULL)',
    );
  }
  ...
  Future<void> write(String key, Map<String, Object?> payload) async {
    ...
    await _database.insert('cost_public_cache', <String, Object?>{
      'cache_key': key,
      'version': 1,
