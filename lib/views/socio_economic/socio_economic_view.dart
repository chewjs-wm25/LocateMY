...
class _SocioEconomicViewState extends State<SocioEconomicView> {
  ...
  void _ensureLoaded(
    SocioEconomicProvider provider,
  ...
  Widget _buildError(BuildContext context, AppLocalizations l10n,
      SocioEconomicProvider provider, String district) {
    return Center(
      child: Padding(
  ...
  Widget _buildIncomeHero(BuildContext context, AppLocalizations l10n,
      Map<String, dynamic> data, String district) {
    ...
    return BentoCard(
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildClassIndicator(context, 'B40', l10n.lowIncome, AppColors.warning, shareB40),
              _buildClassIndicator(context, 'M40', l10n.middleClass, AppColors.primaryBase, shareM40),
              _buildClassIndicator(context, 'T20', l10n.highIncome, AppColors.success, shareT20),
            ],
          ),
          const SizedBox(height: 12),
          ...
          child: BentoCard(
            child: Column(
              ...
              children: [
                ...
                if (gini != null)
                  StatusBadge(
                    label: gini < 0.35 ? '较均衡' : (gini < 0.45 ? l10n.moderate : '较悬殊'),
                    type: gini < 0.35
                        ? StatusType.success
  ...
  Widget _buildDistributionCurve(BuildContext context, AppLocalizations l10n,
      Map<String, dynamic> data) {
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(l10n.incomeDistributionCurve,
                  style: Theme.of(context).textTheme.titleMedium),
  ...
  Widget _buildIncomePosition(BuildContext context, AppLocalizations l10n,
      SocioEconomicProvider provider, Map<String, dynamic> data) {
    final median = data['median_income'] as num?;
    double? percentile;
    if (_income != null) {
    ...
    return BentoCard(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(l10n.monthlyHouseholdIncome,
  ...
  Widget _buildClassIndicator(BuildContext context, String label, String desc,
      Color color, double? share) {
