-- Preserve all expected source statuses even before promotion; reject mismatched snapshot provenance.
...
('gtfs_static_mybas_kuching','https://api.data.gov.my/gtfs-static/mybas-kuching')
 ...
 when parse_status='failed' or f.source_id<>e.feed_id or f.source_url<>e.source_url or captured_at is null or service_start is null or service_end is null then 'failed'
